...
<?php
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	//$user="saniith.s@gmail.com";             /* Authentication user name                    */
	//$password="lmrssmbzv@pundach";           /* Authentication password                     */
	$user="sanith.sumanthran@netscribes.com";             /* Authentication user name                    */
	$password="lmrssmbzv";           /* Authentication password                     */
