...
//foreach($emails as $mail) {
	if($emailcount >= 1)
	{
		...
		for($i=0;$i<=$emailcount;$i++)
		{
			...
			$sitename  = strpos($subject1, 'httpfilenukecom');
			if($sitename != "")
			{
				$site_name = "http://filenuke.com";
				...
				$post_data['token']   = "7bc178e4184d4aa38285150ddcfebda1";;
				...
				$curl_connection = curl_init('http://filenuke.com/contact');
