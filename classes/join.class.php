...
class Join extends DBconn{
	...
	public function csv_escalated($crit)
	{
		$sql = "SELECT ticket.ticket_id, status.status, complaint_type, brands.brand_name, clasification_type, levelone_name, priority_desc, dept_name, ticket.attachment, ticket.requested_date, ticket.created_date,ticket.updated_date, DATEDIFF( ticket.updated_date, ticket.created_date ) AS TAT, st.st_firstname, st.st_lastname ,ticket.summary,ticket.complaint_details,ticket.store_information, customer.firstname, customer.lastname, customer.mobile_no, customer.address, customer.city,customer.state, customer.email_id, customer.card_details, tonality.tonality_type
			...
			LEFT JOIN nipl_tonality tonality ON ticket.tonality_id = tonality.tonality_id
			LEFT JOIN nipl_status status ON ticket.status=status.status_id 
			" . $crit ." order by ticket.created_date desc";
		$result = $this->sql_fetchrowset($this->sql_query($sql));
		return $result;
	}
	...
	{
		$sql = "SELECT ticket.ticket_id, ticket.complaint_id, ticket.store_information, ticket.controladmin_view, brands.brand_name, status.status, complaint_type, ticket.clasification_id, clasification_type, ticket.levelone_id, levelone_name, ticket.priority_id, priority_desc, ticket.dept_id, dept_name, ticket.attachment, ticket.created_date,ticket.updated_date, ct.firstname, ct.lastname, ct.email_id, ct.mobile_no
			FROM nipl_ticket ticket
			LEFT JOIN nipl_clasification clasification ON ticket.clasification_id = clasification.clasification_id
			LEFT JOIN nipl_complaint complaint ON ticket.complaint_id = complaint.complaint_id
			LEFT JOIN nipl_levelone levelone ON ticket.levelone_id = levelone.levelone_id
	...
	{
		$sql = "SELECT ticket.ticket_id, status.status, complaint_type, brands.brand_name, clasification_type, levelone_name, priority_desc, dept_name, ticket.attachment, ticket.requested_date, ticket.created_date,ticket.updated_date, DATEDIFF( ticket.updated_date, ticket.created_date ) AS TAT, st.st_firstname, st.st_lastname ,ticket.summary,ticket.complaint_details,ticket.store_information, st.st_firstname, st.st_lastname, customer.firstname, customer.lastname, customer.mobile_no, customer.address, customer.city,customer.state, customer.email_id, customer.card_details, tonality.tonality_type
			FROM nipl_ticket ticket
			LEFT JOIN nipl_clasification clasification ON ticket.clasification_id = clasification.clasification_id
			LEFT JOIN nipl_complaint complaint ON ticket.complaint_id = complaint.complaint_id
			LEFT JOIN nipl_levelone levelone ON ticket.levelone_id = levelone.levelone_id
	...
	{
		$sql = "SELECT ticket.ticket_id, status.status, complaint_type, brands.brand_name, clasification_type, levelone_name, priority_desc, dept_name, ticket.attachment,  ticket.requested_date, ticket.created_date,ticket.updated_date, DATEDIFF( ticket.updated_date, ticket.created_date ) AS TAT, st.st_firstname, st.st_lastname,ticket.summary,ticket.complaint_details, ticket.store_information, customer.firstname, customer.lastname, customer.mobile_no, customer.address, customer.city,customer.state, customer.email_id, customer.card_details, t.tonality_type
				FROM nipl_ticket ticket
				LEFT JOIN nipl_clasification clasification ON ticket.clasification_id = clasification.clasification_id
				LEFT JOIN nipl_complaint complaint ON ticket.complaint_id = complaint.complaint_id
				LEFT JOIN nipl_levelone levelone ON ticket.levelone_id = levelone.levelone_id
